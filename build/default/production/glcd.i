...
; data lines PortD
;
; RS: (possibly D/I in datasheet) -> ((PORTB) and 0FFh), 2, a
; high - Data
; low - Instruction
;
; R/W: -> ((PORTB) and 0FFh), 3, a
; high - Read from module
; low - Write to module
;
; E - Enable line -> ((PORTB) and 0FFh), 4, a
; D0-D7 - Data lines -> ((PORTD) and 0FFh), 0, a-7
; RST - Display reset -> ((PORTB) and 0FFh), 5, a
; CS1 - Select xx half -> ((PORTB) and 0FFh), 0, a
; CS2 - Select xx half -> ((PORTB) and 0FFh), 1, a
